...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter@v0.4.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ops, sequences, special, tools, utils } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter@v0.4.0-deno/mod.js';
```
